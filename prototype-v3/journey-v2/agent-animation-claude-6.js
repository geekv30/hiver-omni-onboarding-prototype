/*
  Agent creation, as a ~30s five-act piece — variant 6, inverted.

  Same acts, same geometry, same timings as agent-animation-claude.js. What
  changes is the ink: deep blue-greys drawn source-over onto a transparent
  canvas that the stylesheet multiplies down onto the wave. Additive `lighter`
  is wrong here in the most literal way — it sums toward brighter, so dense
  clusters of dark ink would come out pale exactly where they should be
  strongest.
